...
\begin{abstract}
We describe the redesign of a production financial analysis runtime from a domain-hardcoded planner architecture to a lightweight single-loop agent, informed by architectural patterns observed in commercial coding agents (Claude Code, Codex CLI, Cursor, Windsurf).
...
Our team operates a production financial analysis service where users ask natural-language questions and receive data-grounded answers backed by SQL queries, news retrieval, and portfolio analysis.
